...
window.CarBoxPDF = (function () {
  ...
  async function exportActiveCar() {
    ...
    for (var p = 1; p <= pages; p++) {
      ...
      doc.text('Generated by Coilover · ' + dstr, M, H - 20);
  ...
  function downloadOrShare(blob, fname) {
    ...
    try {
      if (navigator.canShare) {
        ...
        if (navigator.canShare({ files: [file] })) { navigator.share({ files: [file], title: 'Coilover history' }).catch(function () {}); return; }
      }
    } catch (e) {}
